                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">NEWS APPROVAL</h4>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">PENDING NEWS</h4>
                                                    ...
                                                    <table id="tech-companies-1" class="table  table-striped">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <div class="form-group">
                                                                <div>
                                                                    <button type="submit" class="btn btn-success waves-effect waves-light" name="accept" id="accept"><a href="accept.php?news_id=<?php echo  $fetch['news_id']; ?>" style="color: white;">
                                                                       ACCEPT
                                                                   </a>
                                                                    </button>
                                                                </div>
                                                           ...
                                                           <td>
                                                            ...
                                                            <div class="form-group">
                                                                <div>
                                                                    <button type="submit" class="btn btn-danger waves-effect waves-light" name="reject" id="reject"><a href="reject.php?news_id=<?php echo  $fetch['news_id']; ?>" style="color: white;">
                                                                       REJECT
                                                                   </a>
                                                                    </button>
                                                                </div>
