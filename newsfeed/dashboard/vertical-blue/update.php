...
if(isset($_POST['submit'])){
   ...
   $conn = mysqli_connect("localhost", "root", "", "newsportal");
    ...
    $news_images = $_POST['news_image'];
    $news_desc = $_POST['news_desc'];
    $posting_date =$_POST['posting_date'];

    
     mysqli_query($conn,"UPDATE news SET news_title='$news_title', cat_id='$cat_id', subcat_id='$subcat_id', news_images='$news_images' , news_desc='$news_desc' , posting_date='$posting_date' where news_id='$id'");
                                ...
                                <div class="col-lg-6">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <form method="post" action="addpost_connect.php">
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        <button type="submit" class="btn btn-primary waves-effect waves-light" name="submit" id="sweet">
                                                            ADD POST
                                                        </button>
