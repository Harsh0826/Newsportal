      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        ...
        while ($row4=mysqli_fetch_array($query4)){
         ?>   
            ...
            <ol class="breadcrumb">
              <li><a href="index.php">Home</a></li>
              <li><a href="#"><?php echo $row4['cat_name']; ?></a></li>
              <li class="active"><?php echo  $row4['subcat']; ?></li>
            </ol>
         
            <h1><?php echo $row4['news_title']; ?> </h1>
            <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i>Wpfreeware</a> <span><i class="fa fa-calendar"></i><?php echo $row4['posting_date']; ?></span> <a href="#"><i class="fa fa-tags"></i><?php echo $row4['subcat']; ?></a>
