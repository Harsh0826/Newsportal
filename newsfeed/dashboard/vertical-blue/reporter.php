                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">ADD REPORTER</h4>                                    
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                                ...
                                <div class="col-lg-6">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">ADD REPORTER</h4>
                                    
            
                                            <form method="post" action="reporter_connect.php">
                                                <input type="Hidden"  name="id" >
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Name</label>
                                                    <input type="text" class="form-control" required placeholder="Type Name"  name="fname"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Username</label>
                                                    <input type="text" class="form-control" required placeholder="Type Username"  name="uname"/>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <label class="bmd-label-floating">Hod Id</label>
                                                    <input type="Password" class="form-control" required placeholder="Type hod id"  name="hod_id"/>
                                                </div>
