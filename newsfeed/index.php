...
?>
  ...
  ?>
          <div class="single_iteam"> <a href="single_page.php?type3=<?php echo $row["news_id"];?>?type3=<?php echo $row["news_id"];?>"> <img src="images/<?php echo $row['news_images']; ?>" alt=""></a>
     ...
     ?>
            <div class="single_post_content_left">
              <ul class="business_catgnav  wow fadeInDown">
                <li>
                  <figure class="bsbig_fig"> <a href="single_page.php?type3=<?php echo $row["news_id"];?>?type3=<?php echo $row["news_id"];?>" class="featured_img"> <img alt="" src="images/<?php echo $row['news_images']; ?>"> <span class="overlay"></span> </a>
                    <figcaption> <a href="single_page.php?type3=<?php echo $row["news_id"];?>?type3=<?php echo $row["news_id"];?>"><p> <?php echo $row['news_title']; ?></p>
                      <p><?php echo $row['news_desc']; ?></p>
                  </figure>
                </li>
              </ul>
    ...
    while ($row=mysqli_fetch_array($query)) {
     ?>
                <ul class="business_catgnav wow fadeInDown">
                  <li>
                    <figure class="bsbig_fig"> <a href="single_page.php?type3=<?php echo $row["news_id"];?>?type3=<?php echo $row["news_id"];?>" class="featured_img"> <img alt="" src="images/<?php echo $row['news_images']; ?>"> <span class="overlay"></span> </a>
                      <figcaption> <a href="single_page.php?type3=<?php echo $row["news_id"];?>?type3=<?php echo $row["news_id"];?>"><?php echo $row['news_title']; ?></a> </figcaption>
                      <p><?php echo $row['news_desc']; ?></p>
                    </figure>
                  </li>
                </ul>
    ...
    while ($row=mysqli_fetch_array($query)) {
     ?>
                <ul class="business_catgnav">
                  <li>
                    <figure class="bsbig_fig wow fadeInDown"> <a href="single_page.php?type3=<?php echo $row["news_id"];?>?type3=<?php echo $row["news_id"];?>" class="featured_img"> <img alt="" src="images/<?php echo $row['news_images']; ?>"> <span class="overlay"></span> </a>
                      <figcaption> <a href="single_page.php?type3=<?php echo $row["news_id"];?>?type3=<?php echo $row["news_id"];?>"><?php echo $row['news_title']; ?></a> </figcaption>
                      <p><?php echo $row['news_desc']; ?></p>
                    </figure>
                  </li>
    ...
    while ($row=mysqli_fetch_array($query)) {
     ?>
            <div class="single_post_content_left">
              <ul class="business_catgnav">
                <li>
                  <figure class="bsbig_fig  wow fadeInDown"> <a class="featured_img" href="single_page.php?type3=<?php echo $row["news_id"];?>?type3=<?php echo $row["news_id"];?>"><img src="images/<?php echo $row['news_images']; ?>" alt=""> <span class="overlay"></span> </a>
                    <figcaption> <a href="single_page.php?type3=<?php echo $row["news_id"];?>?type3=<?php echo $row["news_id"];?>"><?php echo $row['news_title']; ?></a> </figcaption>
                    <p><?php echo $row['news_desc']; ?></p>
                  </figure>
                </li>
