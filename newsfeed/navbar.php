 ...
 <section id="navArea">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        ...
        <?php } ?>
          ...
          <li style="margin-left: 160px; margin-top: 12px;">
                <form id="searchform" method="POST" action="" style="margin-top: -50px;">
                      <input type="text" placeholder="Search.." id="search" style="border-radius: 5px; margin-left: 680px;">
    ...
    while ($row=mysqli_fetch_array($query)) {
     ?>
            <li><a href=" <?php echo $row['news_title']; ?>"><img src="images/<?php echo $row['news_images']; ?>" alt=""><?php echo $row['news_title']; ?></a></li>
            <?php } ?>
          </ul>
