...
?>
  ...
  <section id="contentSection">
    ...
    $sql="SELECT * from news where news_title like'%".$search1."%' ";
    ...
    if($row= mysqli_fetch_assoc($result1)){
         ...
         ?>   
            ...
            <div class="post_commentbox"> <span><i class="fa fa-calendar"></i><?php echo $row['posting_date']; ?></span> <a href="#"><i class="fa fa-tags"></i><?php echo $row['subcat']; ?></a>
            ...
            <div class="single_page_content"> <img style="height:400px; width: 700px;" class="img-center" src="images/<?php echo $row['news_images']; ?> " alt="" >
